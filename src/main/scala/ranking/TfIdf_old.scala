...
object TfIdf_old {
    def main(args : Array[String]): Unit = {
        val spark = SparkSession.builder.appName("TfIdf_old").config("spark.sql.shuffle.partitions", "240").getOrCreate()
        ...
        val streamingQuery_wordcount = tfIdfDataFrame.writeStream
                                .format("console")
                                .outputMode("complete")
